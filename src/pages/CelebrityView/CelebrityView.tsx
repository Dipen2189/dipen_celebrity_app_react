...
import ReactstrapFormikInput from '../../components/common/ReactstrapFormikInput';
...
const CelebrityViewComponent = () => {
    const { CelebrityList, gender, edit, setEddit, deleteElement, setDeleteElement, search, setSearch } =
